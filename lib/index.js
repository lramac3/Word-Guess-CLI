 ...
 */
function printLose() {
    console.log(chalk.keyword('green')(`The answer was:
${newWord.arrRawDisp()}`));
...
function initializeGame() {
    ...
    console.log(chalk.magentaBright("Your word is: "));

    console.log(chalk.yellowBright(newWord.displayWord()));
    console.log(`\n`);
...
function checkWin() {
    ...
    if (isDone) {
        ...
        console.log(chalk.keyword('orange')(`${guessesLeft} guesses remaining!`));
        console.log(newWord.displayWord());
        console.log(chalk.yellow(`You have guessed: "${guessedLetters}"\n`));
        playGame();
    } else {
        printLose();
        playAgain();
